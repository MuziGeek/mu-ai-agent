...
为什么需要hashCode，主要是为了方便用在Hash结构的数据结构中，因为对于这种数据结构来说，想要把一个对象存进去，需要定位到他应该存放在哪个桶中，而这个桶的位置，就需要通过一个整数来获取，然后再对桶的长度取模（实际hashmap要比这复杂一些，可以看：[https://www.yuque.com/hollis666/un6qyk/sz24zwwrdg92qizg](https://www.yuque.com/hollis666/un6qyk/sz24zwwrdg92qizg)）。
...
> 更新: 2024-04-27 11:53:38  
> 原文: <https://www.yuque.com/hollis666/un6qyk/pp2gpau34dpwl15x>