...
EasyExcel 之所以能在处理大型 Excel 文件时保持较低的内存占用，主要归功于其**SAX解析设计（逐行读取+事件机制）**和**磁盘缓存策略**。（本文主要介绍EasyExcel的文件读取占用内存小的原因，文件写入其实和POI的 SXSSFWorkbook  原理一样的。直接看<https://www.yuque.com/hollis666/un6qyk/ivczis4gyskog9q2> 就可以了）
...
![1752849969272-fd756c43-efa4-45ad-a003-dc46561f0893.png](./img/VzXylnZrlgbkbVlH/1752849969272-fd756c43-efa4-45ad-a003-dc46561f0893-992646.png)
...
![1752849590979-424a1195-a26b-4dd7-bbfb-ab7cebd2ee98.png](./img/VzXylnZrlgbkbVlH/1752849590979-424a1195-a26b-4dd7-bbfb-ab7cebd2ee98-250664.png)


> 更新: 2025-07-18 23:14:26  
> 原文: <https://www.yuque.com/hollis666/un6qyk/lwaomovww7yr4v7z>